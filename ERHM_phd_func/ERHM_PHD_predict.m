function [w_k,a_k,b_k,m_k,P_k,J_k] = ERHM_PHD_predict(w_k1,alpha_k1,beta_k1,m_k1,P_k1,J_k1,model,ego)
% temporal evoluation of the kinematic state, the extension is constant
F_k1 = model.RHM.F_k;
Q_k1 = model.RHM.Q_k;
eta_k = model.RHM.eta_k;
...
for j = 1:J_gam_k
    ...
    a_k(1,i) = a_gam_k;
    b_k(1,i) = b_gam_k;
    m_k(:,i) = m_gam_k(:,j) + [ego(1:2,:);zeros(5,1)];
    P_k(:,:,i) = P_gam_k;
end
